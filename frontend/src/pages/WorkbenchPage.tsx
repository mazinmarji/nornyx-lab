    ...
    <div className="page">
      ...
      <section className="workbench-controls">
        ...
        <div className="form-grid">
          ...
          <label><span>Failure mode</span><select value={options.failure_mode} onChange={(event) => setOptions({ ...options, failure_mode: event.target.value as DemoOptions["failure_mode"] })}><option value="fail_closed">Fail closed</option><option value="fail_open">Fail open</option><option value="bounded">Bounded</option></select></label>
